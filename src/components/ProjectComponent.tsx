    ...
    return (
        ...
        >
            ...
            <section className="w-full min-h-screen flex flex-col">
                ...
                <section className="w-full bg-[#664f35] flex flex-col gap-3 py-[9.75rem] px-[1rem] lg:px-[2.5rem]">
                    <h1 className="text-[112px] font-semibold tracking-[-6.8px] leading-[1em] text-[rgb(170,136,103)] text-center">
                        Project Collection
                    </h1>
                    <div className="grid lg:grid-cols-3 px-10 gap-8 mt-28">
                        {articles.map((article, index) => (
                            <div key={index} className="bg-[rgb(170,136,103)] p-4">
                                ...
                                <Link
                                    href="/"
                                    className="text-[14px] mt-7 text-[#333333] text-left flex gap-3 items-center"
                                >
...
// TextRotate and AnimatedLogoCloud remain unchanged
