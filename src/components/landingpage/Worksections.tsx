    ...
    return (
        <>
            <section className='flex flex-col  bg-white overflow-hidden gap-[100px]   w-full h-min py-[3.7rem] pr-[5rem] pl-[10rem]  mx-auto relative'>
                <h1 className='text-[112px] mt-28 tracking-[-6.8px] text-left leading-[1em] text-[rgb(170,136,103)]'> Work Collection
                </h1>
                <div className="grid grid-cols-7">
                    <div className="col-span-4 mt-14 group">
                        <img src='/CtqdgxpGYO4WFK0ftEeQyDERY0w.avif' className=' object-cover w-full pr-20'></img>
                    ...
                    <div className="col-span-3 group p-4">
                        <div className=' flex flex-col gap-6'>
                            <div className="flex items-center gap-6 justify-start">
                                <img
                                    ...
                                    className="size-7"
                                />
                                <h1 className="text-[24px] font-medium tracking-[-1px] text-left text-[rgb(102,79,53)]">
                                    Featured Projects
                                </h1>
                            </div>
                        ...
                        <div className=' mt-80'>
                            <img src='/TTdNsUIJ7hNa3fW196hmNHfRznM.png' className='w-full h-[36rem]  object-cover ' alt='sofa'></img>
                        </div>
                ...
                <div className="grid grid-cols-7">
                    <div className="col-span-3 pr-7 group mt-[34rem]">
                        <img src='/xY2ltysjjeDPAv2h8IdjICqEio_1.png' className='w-full h-[36rem]  object-cover ' alt='sofa'></img>
                        <h1 className='  text-xl font-medium mt-2 group-hover:font-semibold'>Scorpia</h1>
                    </div>
                    <div className="col-span-4  mt-20 group ml-24">
                        <img src='/fpSz08cqO9CONW7pXT8QyafavKA_1.png' className=' object-cover w-fullp -20'></img>
